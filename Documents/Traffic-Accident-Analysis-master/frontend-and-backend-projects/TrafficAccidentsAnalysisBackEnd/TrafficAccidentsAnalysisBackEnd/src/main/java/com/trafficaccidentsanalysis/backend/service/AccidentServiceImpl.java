...
public class AccidentServiceImpl implements AccidentService {
	...
	@Override
	public List<Vehicle> getAccidentVehicle(int id) {
		return vehicleRepository.findByAccidentAccidentid(id);
		
	}

	@Override
	public List<Accident> getAccidentsByRoadType(RoadTypeDto roadTypeDto) {
	return this.accidentRepository.getAccidentsByRoadType(roadTypeDto.getRoadTypeDto());
	}

	@Override
	public List<Accident> getAccidentsByWeatherDuringAccident(WeatherDuringAccidentDto weatherDuringAccidentDto) {
		return this.accidentRepository.getAccidentsByWeatherDuringAccident(weatherDuringAccidentDto.getWeatherDuringAccidentDto());
	}
