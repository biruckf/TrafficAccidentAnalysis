...
public class AccidentDto {
	...
	private Set<PersoninvehicleDto> personInVehicleDto;
	...
	public Set<PersoninvehicleDto> getPersonInVehicleDto() {
		return personInVehicleDto;
	}
	public void setPersonInVehicleDto(Set<PersoninvehicleDto> personInVehicleDtos) {
		if(this.personInVehicleDto == null) {
			this.personInVehicleDto= new HashSet<PersoninvehicleDto>();
		}
		for(PersoninvehicleDto p:personInVehicleDtos) {
			getPersonInVehicleDto().add(p);
			
		}
		
		this.personInVehicleDto = personInVehicleDto;
	}
